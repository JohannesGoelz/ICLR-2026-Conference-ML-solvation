...
To illustrate the impact of solvent on conformational sampling, we ran a 1\,\textmu s simulation of the tetrapeptide FHWN in two settings: (i) explicit TIP3P water and (ii) vacuum. Figure~\ref{fig:fhwn_solvated_vs_vacuum} compares the resulting thermodynamic and kinetic projections. The explicit-solvent simulation explores broader and more structured regions of conformational space, whereas the vacuum simulation collapses into fewer dominant basins.


\begin{figure*}[htbp]
    \centering
    % TODO: replace with your final file path
    \includegraphics[width=\linewidth]{images/tetrapeptide_vacuum.png}
    \caption{Conformational comparison for FHWN over 1\,\textmu s in explicit water (top row) and vacuum (bottom row). Left: Ramachandran PMFs for the residue pairs F--H, H--W, and W--N. Right: corresponding \gls{tica} projection (TIC 0 vs TIC 1). The solvent model induces different thermodynamic basins and kinetic organization than vacuum dynamics.}
    \label{fig:fhwn_solvated_vs_vacuum}
\end{figure*}
