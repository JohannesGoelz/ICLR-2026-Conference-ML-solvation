...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{images/throughput_300K.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{images/throughput_reform.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{images/scaling_plot.pdf}
