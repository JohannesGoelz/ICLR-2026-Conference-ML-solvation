...
To illustrate the impact of solvent on conformational sampling, we ran a 1\,\textmu s simulation of the tetrapeptide FHWN in two settings: (i) explicit TIP3P water and (ii) vacuum. Figure~\ref{fig:fyva_solvated_vs_vacuum} compares the resulting thermodynamic and kinetic projections. The explicit-solvent simulation explores broader and more structured regions of conformational space, whereas the vacuum simulation collapses into fewer dominant basins.
